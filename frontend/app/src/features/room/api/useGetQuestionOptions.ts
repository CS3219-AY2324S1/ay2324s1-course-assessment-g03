...
const getQuestionOptions = async (difficulty: DifficultyType[], topic: TopicTagType[]) => {
...
export const useGetQuestionOptions = (difficulty: DifficultyType[], topic: TopicTagType[]) => {
