 ...
 * > **NOTE:** Groups and projects are synonymous terms. You may find `groupId` in the official documentation.
 */
export declare function getDataLakePipelineRunOutput(args: GetDataLakePipelineRunOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDataLakePipelineRunResult>;
/**
 * A collection of arguments for invoking getDataLakePipelineRun.
 */
