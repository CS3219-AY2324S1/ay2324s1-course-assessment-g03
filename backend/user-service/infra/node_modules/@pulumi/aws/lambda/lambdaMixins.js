...
class CallbackFunction extends function_1.Function {
    constructor(name, args, opts = {}) {
        ...
        const functionArgs = Object.assign(Object.assign({}, args), { code: code, handler: serializedFileNameNoExtension + "." + handlerName, runtime: args.runtime || _1.Runtime.NodeJS16dX, role: iam.Role.isInstance(role) ? role.arn : role, timeout: args.timeout === undefined ? 180 : args.timeout });
