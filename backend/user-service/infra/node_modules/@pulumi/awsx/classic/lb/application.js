...
exports.ApplicationListener = exports.ApplicationTargetGroup = exports.ApplicationLoadBalancer = void 0;
 ...
 * more details.
 */
class ApplicationLoadBalancer extends loadBalancer_1.LoadBalancer {
    constructor(name, args = {}, opts = {}) {
        const argsCopy = Object.assign(Object.assign({ vpc: args.vpc || ec2.Vpc.getDefault(opts) }, args), { loadBalancerType: "application" });
 ...
 * balancer.
 */
class ApplicationTargetGroup extends targetGroup_1.TargetGroup {
    constructor(name, args = {}, opts = {}) {
