...
exports.buildAndPushImage = exports.Repository = void 0;
...
class Repository extends pulumi.ComponentResource {
    ...
    buildAndPushImage(pathOrBuild) {
        return pulumi.all([pathOrBuild, this.repository.repositoryUrl, this.repository.registryId])
            .apply(([pathOrBuild, repositoryUrl, registryId]) => (0, ecs_1.computeImageFromAsset)(pathOrBuild, repositoryUrl, registryId, this));
    }
}
