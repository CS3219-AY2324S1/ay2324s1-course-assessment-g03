...
export declare abstract class Image implements ContainerImageProvider {
    abstract image(name: string, parent: pulumi.Resource): pulumi.Input<string>;
    abstract environment(name: string, parent: pulumi.Resource): pulumi.Input<KeyValuePair[]>;
    /**
