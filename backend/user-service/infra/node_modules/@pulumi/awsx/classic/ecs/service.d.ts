...
export declare abstract class Service extends pulumi.ComponentResource {
     ...
     */
    readonly listeners: Record<string, lb.Listener>;
    readonly applicationListeners: Record<string, lb.ApplicationListener>;
    readonly networkListeners: Record<string, lb.NetworkListener>;
