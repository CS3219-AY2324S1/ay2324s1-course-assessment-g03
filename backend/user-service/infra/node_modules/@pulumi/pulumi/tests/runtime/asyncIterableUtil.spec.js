...
describe("PushableAsyncIterable", () => {
    it("correctly produces empty sequence", () => __awaiter(void 0, void 0, void 0, function* () {
        const queue = new asyncIterableUtil_1.PushableAsyncIterable();
        queue.complete();
        assert.deepStrictEqual(yield enumerate(queue), []);
    }));
    it("correctly produces singleton sequence", () => __awaiter(void 0, void 0, void 0, function* () {
        const queue = new asyncIterableUtil_1.PushableAsyncIterable();
        queue.push(1);
        queue.complete();
        assert.deepStrictEqual(yield enumerate(queue), [1]);
    }));
    it("correctly produces multiple sequence", () => __awaiter(void 0, void 0, void 0, function* () {
        const queue = new asyncIterableUtil_1.PushableAsyncIterable();
        queue.push(1);
        queue.push(2);
        queue.push(3);
    ...
    it("correctly terminates outstanding operations afte complete", () => __awaiter(void 0, void 0, void 0, function* () {
        const queue = new asyncIterableUtil_1.PushableAsyncIterable();
        const queueIter = queue[Symbol.asyncIterator]();
        const terminates = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("correctly interleaves operations", () => __awaiter(void 0, void 0, void 0, function* () {
        const queue = new asyncIterableUtil_1.PushableAsyncIterable();
        const queueIter = queue[Symbol.asyncIterator]();
        queue.push(1);
        queue.push(2);
