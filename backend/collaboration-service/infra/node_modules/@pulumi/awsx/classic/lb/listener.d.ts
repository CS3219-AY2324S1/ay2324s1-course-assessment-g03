...
import { ContainerLoadBalancerProvider, ContainerPortMappingProvider } from "../ecs/container";
...
export declare abstract class Listener extends pulumi.ComponentResource implements ContainerPortMappingProvider, ContainerLoadBalancerProvider {
    readonly listener: aws.lb.Listener;
    readonly loadBalancer: LoadBalancer;
    readonly defaultTargetGroup?: TargetGroup;
    ...
    containerLoadBalancer(name: string, parent: pulumi.Resource): pulumi.Input<import("../ecs/container").ContainerLoadBalancer>;
    addListenerRule(name: string, args: ListenerRuleArgs, opts?: pulumi.ComponentResourceOptions): ListenerRule;
    /**
     * Attaches a target to the `defaultTargetGroup` for this Listener.
     */
    attachTarget(name: string, args: LoadBalancerTarget, opts?: pulumi.CustomResourceOptions): import("./targetGroupAttachment").TargetGroupAttachment;
}
/**
