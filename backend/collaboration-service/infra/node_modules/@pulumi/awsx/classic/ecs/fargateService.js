...
exports.getSubnets = exports.FargateService = exports.FargateTaskDefinition = void 0;
...
class FargateTaskDefinition extends taskDefinition_1.TaskDefinition {
    ...
    createService(name, args, opts = {}) {
        ...
        return new FargateService(name, Object.assign(Object.assign({}, args), { taskDefinition: this }), Object.assign({ parent: this }, opts));
    }
}
...
class FargateService extends service_1.Service {
    constructor(name, args, opts = {}) {
        ...
        const taskDefinition = args.taskDefinition ||
            new FargateTaskDefinition(name, Object.assign(Object.assign({}, args.taskDefinitionArgs), { vpc: cluster.vpc }), opts);
