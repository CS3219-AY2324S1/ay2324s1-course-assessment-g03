...
function createAPI(parent, name, args, optsParent) {
    ...
    const restAPI = new aws.apigateway.RestApi(name, Object.assign(Object.assign({}, args.restApiArgs), { name: (0, utils_1.ifUndefined)(restApiArgs.name, title), binaryMediaTypes: (0, utils_1.ifUndefined)(restApiArgs.binaryMediaTypes, ["*/*"]), body: swaggerString }), { parent });
