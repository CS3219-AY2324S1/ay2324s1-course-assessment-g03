...
describe("CustomResource", () => {
    ...
    it("saves provider with same package as the resource in __prov", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // https://github.com/pulumi/pulumi/issues/13777
    it("does not save provider with different package as the resource in __prov", () => __awaiter(void 0, void 0, void 0, function* () {
...
class MyOtherProvider extends resource_1.ProviderResource {
    constructor(name) {
        super("other", name);
    }
}
...
class MyRemoteComponentResource extends resource_1.ComponentResource {
    constructor(name, opts) {
