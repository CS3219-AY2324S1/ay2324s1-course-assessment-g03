...
describe("unwrap", () => {
    ...
    describe("preserves resources", () => {
        ...
        describe("with unknowns", () => {
            it("across 'all' without unknowns", testResources(index_1.all([
                Promise.resolve({ a: createOutput(index_1.unknown, r1, r2) }),
                Promise.resolve({ b: createOutput(index_1.unknown, r3, r4) }),
            ]), undefined, [], [r1, r2, r3, r4]));
            it("across 'all' with unknowns", testResources(index_1.all([
                Promise.resolve({ a: createOutput(index_1.unknown, r1, r2) }),
                Promise.resolve({ b: createOutput(index_1.unknown, r3, r4) }),
            ]), [{ a: index_1.unknown }, { b: index_1.unknown }], [], [r1, r2, r3, r4], 
            /*withUnknowns:*/ true));
        });
        describe("across promise boundaries", () => {
            ...
            }, { a: 1, b: 2, c: { d: [3] } }, [r1, r2, r3, r6], [r1, r2, r3, r5, r6]));
            ...
            it("across 'all'", testResources(index_1.all([
    ...
    describe("type system", () => {
        it("across promises", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("across nested promises", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("across outputs", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("across nested outputs", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("across promise and output", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("across output and promise", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("does not wrap functions", () => __awaiter(void 0, void 0, void 0, function* () {
            var sentinel = function (_) { };
            // `v` should be type `() => void` rather than `UnwrappedObject<void>`.
            index_1.output(function () { }).apply((v) => sentinel(v));
        }));
    });
    it("handles all in one", test(Promise.resolve([1, index_1.output({ a: [Promise.resolve([1, 2, { b: true, c: null }, undefined])] })]), [
        1,
