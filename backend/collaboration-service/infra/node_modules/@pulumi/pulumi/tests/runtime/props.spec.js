...
describe("runtime", () => {
    ...
    describe("transferProperties", () => {
        describe("output values", () => {
            ...
            for (const test of generateTests()) {
                it(`marshals ${test.name} correctly`, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("marshals basic properties correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            const inputs = {
                aNum: 42,
                bStr: "a string",
                cUnd: undefined,
        ...
        it("marshals secrets correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            const inputs = {
        ...
        it("marshals resource references correctly during preview", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("marshals resource references correctly during update", () => __awaiter(void 0, void 0, void 0, function* () {
            index_1.runtime.setMocks(new TestMocks());
            const component = new TestComponentResource("test");
            const custom = new TestCustomResource("test");
            const componentURN = yield component.urn.promise();
    ...
    describe("deserializeProperty", () => {
        ...
        it("deserializes resource references properly during preview", () => __awaiter(void 0, void 0, void 0, function* () {
            index_1.runtime.setMocks(new TestMocks());
            index_1.runtime._setFeatureSupport("resourceReferences", true);
    ...
    describe("resource error handling", () => {
        it("registerResource errors propagate appropriately", () => __awaiter(void 0, void 0, void 0, function* () {
            index_1.runtime.setMocks(new TestMocks());
